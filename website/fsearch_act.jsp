   ...
   try{ 
     ...
     Class.forName("com.mysql.jdbc.Driver"); 
		 ...
		 Statement stmt = con.createStatement(); 
			// 쿼리문장을 쓰기위한 stmt 선언 
	   ResultSet rs0 = stmt.executeQuery("select count(id) from blog where "+searchk+" like '%" + searchw +"%' "); 
	   if (rs0.next()){
	   ...
	   String sql = "select id, title, name, filename from blog where "+searchk+" like '%"+searchw+"%' order by id desc"; 
