...
<% 
   try{ /*  검색하는 항목  */ 
	   ...
	   String searchw = request.getParameter("searchw");
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/15db?useUnicode=true&characterEncoding=utf8", "kim", "1234"); 
	...
	%>
<a href="dbListSearch.jsp">학생 정보 목록 페이지</a>
</body>
</html>